  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="min-h-screen bg-[#050508]">
      ...
      <div ref={heroRef} className="relative h-[85vh] overflow-hidden">
        ...
        {/* Step 2: Return to Insights Button (Liquid Glass Mirror) */}
        <div className="absolute top-10 left-10 z-[50]">
          <button 
            onClick={onBack}
            className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-white/5 border border-white/20 text-white font-bold uppercase tracking-[0.2em] text-[10px] hover:bg-white/10 hover:border-white/40 transition-all shadow-2xl backdrop-blur-xl group"
          >
